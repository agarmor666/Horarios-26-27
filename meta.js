...
(function(){
  ...
  sec.innerHTML=`
    <div style="display:flex;justify-content:space-between;gap:12px;align-items:flex-start;flex-wrap:wrap;margin-bottom:16px">
      <div>
        ...
        <p class="hint" style="margin-bottom:0">Registro de las actuaciones de apoyo y refuerzo realizadas durante el curso 2026/27.</p>
      </div>
    ...
    <div style="padding:14px 16px;border-radius:14px;background:#ecfeff;border:1px solid #a5f3fc;color:#155e75;margin-bottom:16px;font-weight:700">
      Aquí se registra exclusivamente el curso 2026/27: grupo, tramo horario, docente de apoyo, fecha, lugar y tipo de sesión, alumnado atendido, actitud, dificultad, contenidos reforzados y observaciones.
    </div>
  ...
  function showSupport(){
    ...
    apoyo.style.background='linear-gradient(135deg,#2563eb,#7c3aed)';
