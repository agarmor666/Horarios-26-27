...
(function(){
  ...
  async function loadStudents(group){
    ...
    try{
      const r=await fetch(STUDENTS_API+'?action=students-get&group='+encodeURIComponent(group),{credentials:'include',redirect:'follow'});
